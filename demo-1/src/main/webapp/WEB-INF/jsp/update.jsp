...
<body>
	<div id ="wrap">
		<br><br>
		<b><font size="6" color="gray"> UPDATE </font></b>
		<br><br><br>
		<form method="post" action="/updatecomplete.do" name="userInfo" onsubmit="return checkValue()">
			<table>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="PhoneNumber" maxlength="50" value="${PhoneNumber}">
					</td>
				</tr>	
				<tr>
					<td id="title"> Age </td>
				...
				<tr>
					...
					<td>
						<input type="text" name="Works" maxlength="50" value="${Works}">
					</td>
				</tr>
				<tr>
